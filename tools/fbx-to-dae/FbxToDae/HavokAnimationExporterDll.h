...
#define HAE_ERROR_UNSUPPORTED_FORMAT 8
...
__declspec(dllexport) int hae_skeleton_to_dae(const char* hkx_path, const char* output_dae_path);
__declspec(dllexport) int hae_animation_to_dae(const char* hkx_path, const char* skeleton_hkx_path, const char* output_dae_path, float fps);

__declspec(dllexport) int hae_convert_skeleton(const char* fbx_path, const char* output_path);
__declspec(dllexport) int hae_convert_animation(const char* fbx_path, const char* skeleton_path, const char* output_path, float fps, int compress);
__declspec(dllexport) int hae_convert_animation_ex(const char* fbx_path, const char* skeleton_path, const char* output_path, float fps, int compress, int platform);
