...
public sealed class AnimeForestB : MapDefinition
{
    ...
    public static AnimeForestB Instance { get; } = new();

    private AnimeForestB()
        : base("anime_world", "af_b", "Anime Forest B", 20, 20, 24, BaseTileData, OverlayTileData, WalkableTileIds, null, null, 0, -1)
    {
    }
}
