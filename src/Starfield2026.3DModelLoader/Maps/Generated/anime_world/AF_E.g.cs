...
public sealed class AnimeForestE : MapDefinition
{
    ...
    public static AnimeForestE Instance { get; } = new();

    private AnimeForestE()
        : base("anime_world", "af_e", "Anime Forest E", 20, 20, 24, BaseTileData, OverlayTileData, WalkableTileIds, null, null, 1, 0)
    {
    }
}
