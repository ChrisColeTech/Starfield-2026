...
public class CubeRenderer
{
    ...
    private void BuildCube(GraphicsDevice device)
    {
        ...
        var front = new Color(0, 220, 255);
        var back = new Color(255, 50, 150);
        var top = new Color(100, 255, 100);
        var bottom = new Color(255, 160, 0);
        var left = new Color(150, 100, 255);
        var right = new Color(255, 255, 80);
